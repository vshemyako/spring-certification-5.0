 ...
 * 1.1. What is the concept of AOP? {@link spring.certification.aop.Q001_concepts link}<br>
 * 1.2. What problems does AOP solve? {@link spring.certification.aop.Q001_concepts link}<br>
 * 1.3. What is cross cutting concern? {@link spring.certification.aop.Q001_concepts link}<br>
 * 1.4. Name three typical cross cutting concerns. {@link spring.certification.aop.Q001_concepts link}<br>
 ...
 * 4.1. What are the limitations of the two proxy types? {@link spring.certification.aop.Q004_limitations link}<br>
 * 4.2. What visibility must Spring bean methods have to be proxied using Spring AOP?
 * {@link spring.certification.aop.Q004_limitations link}<br>
