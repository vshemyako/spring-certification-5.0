 ...
 * 1.1. What is the concept of AOP? {@link spring.certification.aop.Q001concepts link}<br>
 * 1.2. What problems does AOP solve? {@link spring.certification.aop.Q001concepts link}<br>
 * 1.3. What is cross cutting concern? {@link spring.certification.aop.Q001concepts link}<br>
 * 1.4. Name three typical cross cutting concerns. {@link spring.certification.aop.Q001concepts link}<br>
 * 1.5. What two problems arise if you don't solve a cross cutting concern via AOP?
 * {@link spring.certification.aop.Q001concepts link}<br>
 * 2. What is a pointcut, a join point, an advice, an aspect, a weaving?
 * {@link spring.certification.aop.Q002terminology link}<br>
 ...
 * 4.2. What visibility must Spring bean methods have to be proxied using Spring AOP?
 * {@link spring.certification.aop.Q004limitations link}<br>
 * 5.1. How many advice types does Spring support. Can you name each one?
 * {@link spring.certification.aop.Q005advice link}<br>
 * 5.2. What different advice types are used for? {@link spring.certification.aop.Q005advice link}<br>
 * 5.3. Which types of advices can you use if you would like to try and catch exceptions?
 * {@link spring.certification.aop.Q005advice link}<br>
